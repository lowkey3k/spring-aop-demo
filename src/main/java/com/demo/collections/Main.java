...
//                   特别是它不保证该顺序恒久不变。另外，HashMap是非线程安全的，也就是说在多线程的环境下，
//                   可能会存在问题，而Hashtable是线程安全的。JDK1.8中，HashMap采用数组+链表+红黑树实现，当链表长度超过阈值8时，将链表转换为红黑树，这样大大减少了查找时间。
//                    下面介绍一下HashMap的特点和相关重点问题？
//                   一，HashMap不安全的原因？
//                      1，如果两个线程put元素，如果两个key发生了hash碰撞，那么两个线程会将元素put到同一位置，hashmap是会覆盖的，这样就造成一个线程
//                           的元素丢失。
//                       2,多线程下，如果两个线程同时检测到hashMap要扩容调用resize，那么一个线程进行rehash后和生成新的数组赋给底层table
//                               ，另一个线程也进行了扩容和赋值给底层table，会覆盖操作，其他线程的数据就会丢失，这样会有问题。
...
//                      总结：如果要线程安全： Collections的synchronizedMap方法使HashMap具有线程安全的能力，或者使用ConcurrentHashMap
//                   二，HashMap的容量和扩容都是2的幂次？
//                       详见：https://blog.csdn.net/weixin_38019299/article/details/102592175
//                     三，HashMap中的加载因子？
//                       详见：https://blog.csdn.net/weixin_38019299/article/details/102601544
//                      四，红黑树的原理介绍？
//                          详见：https://blog.csdn.net/weixin_38019299/article/details/102587824
//        /**
...
//                        // Objects.equals方法是Obejcts的静态工具方法，可以使用可变长参数
...
//                   https://blog.csdn.net/weixin_38019299/article/details/102587824
